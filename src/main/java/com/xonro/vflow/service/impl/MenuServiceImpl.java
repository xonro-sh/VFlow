...
import com.xonro.vflow.bean.NodeResponse;
import com.xonro.vflow.bean.TableResponse;
import com.xonro.vflow.dao.MenuRepository;
import com.xonro.vflow.enums.VflowEnums;
import com.xonro.vflow.helper.WebHelper;
...
public class MenuServiceImpl implements MenuService{
    ...
    public BaseResponse getMenu() {
        ...
        baseResponse.setMsg("");
        try {
            baseResponse.setData(JSON.toJSONString(menuRepository.findAll()));
        } catch (Exception e){
            baseResponse.setOk(false);
            baseResponse.setMsg(e.getMessage());
        }
    ...
    public BaseResponse changeMenuIndex(String itemNo, String type) {
        ...
        int itemNoNew = 0;
        if (type.equals(VflowEnums.MENU_UP.getValue())) {
            itemNoNew = Integer.parseInt(itemNo) -1;
        } else if (type.equals(VflowEnums.MENU_DOWN.getValue())){
            itemNoNew = Integer.parseInt(itemNo) +1;
        }
